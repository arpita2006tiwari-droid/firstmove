...
const WhoWeServe = () => {
  const groups = [
    { name: 'Kids — Girls & Boys', img: 'https://images.unsplash.com/photo-1526232761682-d26e03ac148e?q=80&w=2929&auto=format&fit=crop' },
    { name: 'Teens', img: 'https://images.unsplash.com/photo-1551269901-5c5e14c25df7?q=80&w=2938&auto=format&fit=crop' },
    { name: 'Women', img: 'https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=2938&auto=format&fit=crop' },
    { name: 'Men', img: 'https://images.unsplash.com/photo-1530549387722-4c1ba9c87893?q=80&w=2938&auto=format&fit=crop' },
    { name: 'Adults', img: 'https://images.unsplash.com/photo-1554068865-24cecd4e34b8?q=80&w=2940&auto=format&fit=crop' },
    { name: 'Senior Citizens', img: 'https://images.unsplash.com/photo-1566932715839-12eb7dfbc8e7?q=80&w=2940&auto=format&fit=crop' }
  ];
          ...
          {groups.map((group, i) => (
            ...
            onMouseOut={e => {
              ...
              <div className="overlay" style={{
                ...
                <h3 className="font-display" style={{ fontSize: '24px', color: 'var(--ink)', textShadow: '0 4px 12px rgba(0,0,0,0.5)' }}>{group.name}</h3>
              </div>
            </div>
          ))}
        </div>
